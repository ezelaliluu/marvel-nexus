...
const marvelVariants = [
  ...
  },
  {
    ...
    title: "SPIDER GWEN",
    subtitle: "SPIDERVERSE // Gwen Stacy",
    desc: "Spider-Gwen (Gwen Stacy) is a Marvel superhero from an alternate universe where she was bitten by the radioactive spider instead of Peter Parker. Also known as Ghost-Spider, she features an iconic white-and-black hooded suit and gained massive global popularity through the animated movie Spider-Man: Into the Spider-Verse.",
    modelPath: "/models/gwen_stacey_-_into_the_spiderverse.glb",
    scale: 0.9,
    position: [0.0, -1.3, 0],
    rotation: [0, 0, 0],
    accentColor: "#ff009dff",
    accentGlow: "rgba(255, 0, 157, 0.35)",
    badge: "SPIDER-VERSE",
  },
  {
    id: "Spider-Man Symbiote",
    variantName: "Spider-Man Symbiote",
    title: "SPIDER-MAN SYMBIOTE",
    subtitle: "VENOM // SYMBIOTE",
    desc: "Spider-Man Symbiote (also known as Black Suit Spider-Man) is a powerful version of the hero bonded with a liquid alien parasite that later becomes Venom. This living black-and-white suit drastically enhances Peter Parker's strength, speed, and aggression, while generating organic webbing without web-shooters.",
    modelPath: "/models/spider-man_symbiote_spider-man_2_ps5_blend.glb",
    scale: 2.4,
    position: [0.0, -3, 0],
    rotation: [0, 0, 0],
    accentColor: "#110d0dff",
    accentGlow: "rgba(17, 13, 13, 0.35)",
    badge: "SYMBIOTE TECH",
  },
  {
    id: "thanos-conqueror",
    ...
    desc: "Thanos, the Mad Titan, is one of the most formidable villains in the Marvel Universe, obsessed with bringing balance to the cosmos by wiping out half of all life. Wielding the all-powerful Infinity Gauntlet, he seeks ultimate control over reality. His massive purple physique, imposing armor, and strategic genius make him a relentless force across the galaxy.",
