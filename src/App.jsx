...
const marvelVariants = [
  ...
  },
  {
    ...
    variantName: "Nano Gauntlet Matrix",
    title: "NANO GAUNTLET",
    subtitle: "STARK-PIM LABS // COSMIC ARTIFACT",
    ...
    price: "$4,999",
    modelPath: "/models/infinity_gauntlet_textured_no_rig.glb",
    scale: 1.8,
    position: [0.2, -0.55, 0],
    rotation: [0, 0, 0],
    accentColor: "#f59e0b",
    accentGlow: "rgba(245, 158, 11, 0.35)",
    badge: "COSMIC LEVEL THREAT",
  },
  {
    id: "thanos-conqueror",
    ...
    price: "$5,850",
    modelPath: "/models/thanos_4k_retextured.glb",
    scale: 1.05,
